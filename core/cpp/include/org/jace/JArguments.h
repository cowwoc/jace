#ifndef ORG_JACE_JARGUMENTS_H
#define ORG_JACE_JARGUMENTS_H
...
public:
	 ...
	 */
	JACE_API JArguments& add(const ::org::jace::proxy::JValue& value);
	 ...
	 */
	JACE_API JArguments& operator<<(const ::org::jace::proxy::JValue& value);

	/**
	 * Returns this JArguments as a list of JValue*'s.
	 */
	JACE_API std::list<const ::org::jace::proxy::JValue*> asList() const;

private:
	std::list<const ::org::jace::proxy::JValue*> mList;
};
