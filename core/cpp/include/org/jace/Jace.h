#ifndef ORG_JACE_JACE_H
#define ORG_JACE_JACE_H
 ...
 */
template <typename T> T java_cast(const ::org::jace::proxy::JObject& obj)
{
	JNIEnv* env = attach();
	...
	const ::org::jace::JClass& resultClass = T::staticGetJavaJniClass();
 ...
 * @throws JNIException if obj is not convertible to type T.
 */
template <typename T> bool instanceof(const ::org::jace::proxy::JObject& object)
{
	if (object.isNull())
		return false;
