#ifndef ORG_JACE_JOBJECT_H
#define ORG_JACE_JOBJECT_H
 ...
 * @author Toby Reyelts
 */
class JObject: public ::org::jace::proxy::JValue
{
public:
	/**
...
protected:
	 ...
	 */
	JACE_API static jobject newObject(const ::org::jace::JClass& jClass, const ::org::jace::JArguments& arguments);
};
