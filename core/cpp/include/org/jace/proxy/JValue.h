#ifndef ORG_JACE_JVALUE_H
#define ORG_JACE_JVALUE_H
...
public:
	 ...
	 */
	JACE_API virtual const ::org::jace::JClass& getJavaJniClass() const throw (::org::jace::JNIException) = 0;
...
protected:
	 ...
	 */
	JACE_API virtual void setJavaJniValue(jvalue value) throw (::org::jace::JNIException);
