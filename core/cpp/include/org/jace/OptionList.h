#ifndef ORG_JACE_OPTION_LIST_H
#define ORG_JACE_OPTION_LIST_H
...
/**
 * A List of Options. An OptionList is supplied to org::jace::createVm()
...
public:
   ...
   */
  JACE_API SystemProperty(const std::string& name_, const std::string& _value);
...
{
public:
  JACE_API CustomOption(const std::string& _value);
