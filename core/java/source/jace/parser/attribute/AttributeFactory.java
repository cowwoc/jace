...
public class AttributeFactory {
   ...
   */
  private static Map<String, AttributeReader> readerMap = new HashMap<String, AttributeReader>();
  private static UnknownAttributeReader unknownAttributeReader = new UnknownAttributeReader();
  ...
  public Attribute readAttribute(InputStream stream, ConstantPool pool) throws IOException {
    ...
    throw new ClassFormatError("While trying to read an Attribute, a UTF8Constant was expected. Instead, the " +
      "following constant type was encountered: " + c.getClass().getName());
  }
