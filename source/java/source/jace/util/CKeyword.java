...
public class CKeyword {
   ...
   *
   */
  private static final Set<String> CKeywords = new HashSet<String>();
  ...
  /**
   * Adjust the identifier to make sure that it is C++ compatibile.
   *
  ...
  public static String adjust(String identifier) {
    ...
    if (CKeywords.contains(identifier)) {
