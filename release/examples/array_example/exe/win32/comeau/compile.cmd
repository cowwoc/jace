...
%CC% %COMPILER_FLAGS% -I%JACE_ROOT%\include -I..\..\..\..\include -I..\..\..\..\proxies\include -I%JDK_INCLUDE% -I%JDK_OS_INCLUDE% %LOCAL_SOURCE%\*.cpp %LOCAL_PROXY_SOURCE%\jace\proxy\java\io\*.cpp %LOCAL_PROXY_SOURCE%\jace\proxy\java\lang\*.cpp 
