...
#define JACE_PROXY_JAVA_IO_INPUTSTREAMREADER_H
...
/**
 * The Jace C++ proxy class for java/io/InputStreamReader.
 * Please do not edit this class, as any changes you make will be overwritten.
 * For more information, please refer to the Jace Developer's Guide.
 *
 */
class InputStreamReader : public ::jace::proxy::java::io::Reader {
 ...
 *
 */
InputStreamReader( ::jace::proxy::java::io::InputStream p0 );

/**
 * InputStreamReader
 *
 */
InputStreamReader( ::jace::proxy::java::io::InputStream p0, ::jace::proxy::java::lang::String p1 );

/**
 * getEncoding
 *
 */
::jace::proxy::java::lang::String getEncoding();
 ...
 *
 */
InputStreamReader( jvalue value );
InputStreamReader( jobject object );
InputStreamReader( const InputStreamReader& object );
InputStreamReader( const NoOp& noOp );
virtual const JClass* getJavaJniClass() const throw ( JNIException );
static const JClass* staticGetJavaJniClass() throw ( JNIException );
static JEnlister< InputStreamReader> enlister;
};
...
#endif // #ifndef JACE_PROXY_JAVA_IO_INPUTSTREAMREADER_H
