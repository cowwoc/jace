...
#include "jace/peer/org/jace/examples/Singleton.h"
using ::jace::peer::org::jace::examples::Singleton;
...
void ::jace::peer::org::jace::examples::Singleton::initialize()
{
