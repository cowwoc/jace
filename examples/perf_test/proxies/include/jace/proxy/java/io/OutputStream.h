 ...
 *
 */
class OutputStream : public virtual ::jace::proxy::java::lang::Object {
...
static JEnlister< OutputStream> enlister;
};

END_NAMESPACE_4( jace, proxy, java, io )

#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::OutputStream>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::OutputStream>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::io::OutputStream>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::io::OutputStream>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::OutputStream>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::OutputStream>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::OutputStream>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::io::OutputStream>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::OutputStream>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
