...
END_NAMESPACE_4( jace, proxy, java, io )
  ...
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::PrintWriter>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::PrintWriter>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::io::PrintWriter>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::io::PrintWriter>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::PrintWriter>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::PrintWriter>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::PrintWriter>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::io::PrintWriter>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::PrintWriter>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
