 ...
 *
 */
class Writer : public virtual ::jace::proxy::java::lang::Object {
...
END_NAMESPACE_4( jace, proxy, java, io )
  ...
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::Writer>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::io::Writer>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::io::Writer>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::io::Writer>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::Writer>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::Writer>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::Writer>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::io::Writer>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::Writer>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
