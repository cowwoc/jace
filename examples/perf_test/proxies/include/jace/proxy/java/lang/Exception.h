...
END_NAMESPACE_4( jace, proxy, java, lang )
  ...
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::Exception>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::Exception>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::Exception>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::lang::Exception>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Exception>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Exception>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Exception>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::Exception>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Exception>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
