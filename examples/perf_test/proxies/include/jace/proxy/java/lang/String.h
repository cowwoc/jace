 ...
 *
 */
String( ::jace::proxy::java::lang::String p0, CopyConstructorSpecifier ccs );
...
/**
 * Converts a jace::java::lang::String to a std::string.
 *
 */
operator std::string() { return getCString(); }
...
/**
 * Creates a new jstring from a std::string.
 *
 */
jstring createString( const std::string& str );

/**
 * Retrieves a std::string from this String.
 *
 */
...
static JEnlister< String> enlister;
};

END_NAMESPACE_4( jace, proxy, java, lang )

#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::String>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::String>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::String>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::lang::String>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::String>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::String>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::String>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::String>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::String>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
