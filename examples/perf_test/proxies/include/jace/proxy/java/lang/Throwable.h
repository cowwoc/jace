 ...
 *
 */
Throwable( ::jace::proxy::java::lang::Throwable p0, CopyConstructorSpecifier ccs );
 ...
 *
 */
void printStackTrace( ::jace::proxy::java::io::PrintStream p0 );

/**
 * printStackTrace
 *
 */
void printStackTrace( ::jace::proxy::java::io::PrintWriter p0 );
...
END_NAMESPACE_4( jace, proxy, java, lang )
  ...
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::Throwable>::ElementProxy( jarray array, jvalue element, int index );
  template <> ::jace::ElementProxy< ::jace::proxy::java::lang::Throwable>::ElementProxy( const jace::ElementProxy< ::jace::proxy::java::lang::Throwable>& proxy );
#else
  template <> jace::ElementProxy< jace::proxy::java::lang::Throwable>::ElementProxy( jarray array, jvalue element, int index ) : 
...
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Throwable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Throwable>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ );
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Throwable>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::Throwable>& object );
#else
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Throwable>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
