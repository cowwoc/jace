...
END_NAMESPACE_4( jace, proxy, java, lang )
  ...
  template <> jace::ElementProxy< jace::proxy::java::lang::Object>::ElementProxy( jarray array, jvalue element, int index ) : 
    Object( element ), mIndex( index ) {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> jace::ElementProxy< jace::proxy::java::lang::Object>::ElementProxy( const jace::ElementProxy< jace::proxy::java::lang::Object>& proxy ) : 
...
#endif
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Object>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Object>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    Object( value ), fieldID( fieldID_ ) {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::Object>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::Object>& object ) : 
