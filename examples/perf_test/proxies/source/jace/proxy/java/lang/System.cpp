...
END_NAMESPACE_4( jace, proxy, java, lang )
  ...
  template <> jace::ElementProxy< jace::proxy::java::lang::System>::ElementProxy( jarray array, jvalue element, int index ) : 
    jace::proxy::java::lang::System( element ), Object( NO_OP ), mIndex( index ) {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> jace::ElementProxy< jace::proxy::java::lang::System>::ElementProxy( const jace::ElementProxy< jace::proxy::java::lang::System>& proxy ) : 
...
#endif
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::System>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::System>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::java::lang::System( value ), Object( NO_OP ), fieldID( fieldID_ ) {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::lang::System>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::lang::System>& object ) : 
