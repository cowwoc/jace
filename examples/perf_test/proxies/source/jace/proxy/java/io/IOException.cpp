...
END_NAMESPACE_4( jace, proxy, java, io )
  ...
  template <> jace::ElementProxy< jace::proxy::java::io::IOException>::ElementProxy( jarray array, jvalue element, int index ) : 
    jace::proxy::java::io::IOException( element ), Object( NO_OP ), mIndex( index ) {
    JNIEnv* env = ::jace::helper::attach();
    parent = static_cast<jarray>( ::jace::helper::newGlobalRef( env, array ) );
  }
  template <> jace::ElementProxy< jace::proxy::java::io::IOException>::ElementProxy( const jace::ElementProxy< jace::proxy::java::io::IOException>& proxy ) : 
...
#endif
#ifndef PUT_TSDS_IN_HEADER
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::IOException>::JFieldProxy( jfieldID fieldID_, jvalue value, jobject parent_ ) : 
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::IOException>::JFieldProxy( jfieldID fieldID_, jvalue value, jclass parentClass_ ) : 
    ::jace::proxy::java::io::IOException( value ), Object( NO_OP ), fieldID( fieldID_ ) {
    JNIEnv* env = ::jace::helper::attach();
  ...
  template <> ::jace::JFieldProxy< ::jace::proxy::java::io::IOException>::JFieldProxy( const ::jace::JFieldProxy< ::jace::proxy::java::io::IOException>& object ) : 
